...
void register_native_vfs_search_defaults_00738360(void* actual_manager,
    ActualNativeStringPoolStorage& strings,
    const SingletonLifetimeCallbacks& callbacks) {
    // 01: original CALL 00738401 -> 00be25e0
    {
        Owner value(strings);
        value.resize_copy("dds", 3u);
        Owner group(strings);
        group.resize_copy("textures", 8u);
        register_native_vfs_search_extension_00be25e0(actual_manager, &group.header, &value.header, strings, callbacks);
    }
    // 02: original CALL 007384d2 -> 00be25e0
    {
        Owner value(strings);
    ...
    // 03: original CALL 007385a1 -> 00be2600
    {
        Owner value(strings);
        value.resize_copy("textures\\", 9u);
        Owner group(strings);
        group.resize_copy("textures", 8u);
        register_native_vfs_search_directory_00be2600(actual_manager, &group.header, &value.header, strings, callbacks);
    }
    // 04: original CALL 00738670 -> 00be2600
    {
        Owner value(strings);
    ...
    // 05: original CALL 0073873f -> 00be2600
    {
        Owner value(strings);
    ...
    // 06: original CALL 0073880e -> 00be2600
    {
        Owner value(strings);
    ...
    // 07: original CALL 007388dd -> 00be2600
    {
        Owner value(strings);
    ...
    // 08: original CALL 007389ac -> 00be2600
    {
        Owner value(strings);
    ...
    // 09: original CALL 00738a7b -> 00be2600
    {
        Owner value(strings);
    ...
    // 10: original CALL 00738b4a -> 00be2600
    {
        Owner value(strings);
    ...
    // 11: original CALL 00738c19 -> 00be2600
    {
        Owner value(strings);
    ...
    // 12: original CALL 00738ce8 -> 00be2600
    {
        Owner value(strings);
    ...
    // 13: original CALL 00738db7 -> 00be2600
    {
        Owner value(strings);
    ...
    // 14: original CALL 00738e86 -> 00be2600
    {
        Owner value(strings);
    ...
    // 15: original CALL 00738f55 -> 00be2600
    {
        Owner value(strings);
    ...
    // 16: original CALL 00739024 -> 00be2600
    {
        Owner value(strings);
    ...
    // 17: original CALL 007390f3 -> 00be2600
    {
        Owner value(strings);
    ...
    // 18: original CALL 007391c2 -> 00be2600
    {
        Owner value(strings);
    ...
    // 19: original CALL 00739291 -> 00be2600
    {
        Owner value(strings);
    ...
    // 20: original CALL 00739360 -> 00be2600
    {
        Owner value(strings);
    ...
    // 21: original CALL 0073942f -> 00be2600
    {
        Owner value(strings);
    ...
    // 22: original CALL 007394fe -> 00be2600
    {
        Owner value(strings);
    ...
    // 23: original CALL 007395cd -> 00be2600
    {
        Owner value(strings);
    ...
    // 24: original CALL 0073969c -> 00be2600
    {
        Owner value(strings);
    ...
    // 25: original CALL 0073976b -> 00be2600
    {
        Owner value(strings);
    ...
    // 26: original CALL 0073983a -> 00be1480
    {
        Owner value(strings);
        value.resize_copy("interface\\", 10u);
        Owner group(strings);
        group.resize_copy("lua", 3u);
        register_native_vfs_extension_prefix_00be1480(actual_manager, &group.header, &value.header, strings,
            callbacks);
    }
    // 27: original CALL 00739909 -> 00be1480
    {
        Owner value(strings);
    ...
    // 28: original CALL 007399d8 -> 00be1480
    {
        Owner value(strings);
        value.resize_copy("fonts\\", 6u);
        Owner group(strings);
    ...
    // 29: original CALL 00739aa7 -> 00be1480
    {
        Owner value(strings);
        value.resize_copy("textures\\", 9u);
        Owner group(strings);
    ...
    // 30: original CALL 00739b76 -> 00be1480
    {
        Owner value(strings);
    ...
    // 31: original CALL 00739c45 -> 00be25e0
    {
        Owner value(strings);
    ...
    // 32: original CALL 00739d14 -> 00be2600
    {
        Owner value(strings);
    ...
    // 33: original CALL 00739de3 -> 00be2600
    {
        Owner value(strings);
    ...
    // 34: original CALL 00739eb2 -> 00be2600
    {
        Owner value(strings);
    ...
    // 35: original CALL 00739f81 -> 00be2600
    {
        Owner value(strings);
    ...
    // 36: original CALL 0073a050 -> 00be2600
    {
        Owner value(strings);
    ...
    // 37: original CALL 0073a11f -> 00be2600
    {
        Owner value(strings);
    ...
    // 38: original CALL 0073a1ee -> 00be2600
    {
        Owner value(strings);
    ...
    // 39: original CALL 0073a2bd -> 00be2600
    {
        Owner value(strings);
    ...
    // 40: original CALL 0073a38c -> 00be2600
    {
        Owner value(strings);
    ...
    // 41: original CALL 0073a45b -> 00be2600
    {
        Owner value(strings);
    ...
    // 42: original CALL 0073a52a -> 00be1480
    {
        Owner value(strings);
    ...
    // 43: original CALL 0073a5f9 -> 00be1480
    {
        Owner value(strings);
        value.resize_copy("shaders\\", 8u);
        Owner group(strings);
    ...
    // 44: original CALL 0073a6c8 -> 00be25e0
    {
        Owner value(strings);
    ...
    // 45: original CALL 0073a797 -> 00be2600
    {
        Owner value(strings);
    ...
    // 46: original CALL 0073a866 -> 00be2600
    {
        Owner value(strings);
    ...
    // 47: original CALL 0073a935 -> 00be2600
    {
        Owner value(strings);
    ...
    // 48: original CALL 0073aa04 -> 00be2600
    {
        Owner value(strings);
    ...
    // 49: original CALL 0073aad3 -> 00be2600
    {
        Owner value(strings);
    ...
    // 50: original CALL 0073aba2 -> 00be2600
    {
        Owner value(strings);
    ...
    // 51: original CALL 0073ac71 -> 00be2600
    {
        Owner value(strings);
    ...
    // 52: original CALL 0073acf6 -> 00be1480
    {
        Owner value(strings);
    ...
    // 53: original CALL 0073ad7b -> 00be1480
    {
        Owner value(strings);
        value.assign("effects\\postprocess\\");
        Owner group(strings);
    ...
    // 54: original CALL 0073ae00 -> 00be1480
    {
        Owner value(strings);
        value.assign("effects\\postprocess\\");
        Owner group(strings);
    ...
    // 55: original CALL 0073ae85 -> 00be1480
    {
        Owner value(strings);
    ...
    // 56: original CALL 0073af0a -> 00be1480
    {
        Owner value(strings);
    ...
    // 57: original CALL 0073af8f -> 00be25e0
    {
        Owner value(strings);
        value.assign("fsb");
        Owner group(strings);
    ...
    // 58: original CALL 0073b014 -> 00be2600
    {
        Owner value(strings);
    ...
    // 59: original CALL 0073b099 -> 00be2600
    {
        Owner value(strings);
    ...
    // 60: original CALL 0073b11e -> 00be2600
    {
        Owner value(strings);
    ...
    // 61: original CALL 0073b1a3 -> 00be2600
    {
        Owner value(strings);
    ...
    // 62: original CALL 0073b228 -> 00be2600
    {
        Owner value(strings);
    ...
    // 63: original CALL 0073b2ad -> 00be2600
    {
        Owner value(strings);
    ...
    // 64: original CALL 0073b332 -> 00be2600
    {
        Owner value(strings);
    ...
    // 65: original CALL 0073b3b7 -> 00be2600
    {
        Owner value(strings);
    ...
    // 66: original CALL 0073b43c -> 00be2600
    {
        Owner value(strings);
    ...
    // 67: original CALL 0073b4c1 -> 00be2600
    {
        Owner value(strings);
    ...
    // 68: original CALL 0073b546 -> 00be2600
    {
        Owner value(strings);
    ...
    // 69: original CALL 0073b5cb -> 00be25e0
    {
        Owner value(strings);
        value.assign("fev");
        Owner group(strings);
    ...
    // 70: original CALL 0073b650 -> 00be2600
    {
        Owner value(strings);
        value.assign("sound\\events\\");
        Owner group(strings);
    ...
    // 71: original CALL 0073b6d5 -> 00be1480
    {
        Owner value(strings);
        value.assign("movies");
        Owner group(strings);
    ...
    // 72: original CALL 0073b75a -> 00be25e0
    {
        Owner value(strings);
        value.assign("mpak");
        Owner group(strings);
    ...
    // 73: original CALL 0073b7df -> 00be2600
    {
        Owner value(strings);
    ...
    // 74: original CALL 0073b864 -> 00be2600
    {
        Owner value(strings);
    ...
    // 75: original CALL 0073b8e9 -> 00be2600
    {
        Owner value(strings);
    ...
    // 76: original CALL 0073b96e -> 00be2600
    {
        Owner value(strings);
    ...
    // 77: original CALL 0073b9f3 -> 00be2600
    {
        Owner value(strings);
    ...
    // 78: original CALL 0073ba78 -> 00be2600
    {
        Owner value(strings);
