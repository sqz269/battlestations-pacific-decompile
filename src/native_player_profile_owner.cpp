...
void NativePlayerProfileCalls::free_00bf65ac(void* p){singleton_lifetime_free(p);}
void* NativePlayerProfileCalls::allocate_00bf681b(std::uint32_t n){
...
void reset_body(void* profile,NativePlayerProfileContext& c,Op& a) {
    ...
    if(progress){a.native_site=0x007fdc00;calls.call_007fd780(progress);
    ...
    if(a.current_allocation){a.native_site=0x007fdc29;value=calls.call_00920e10(a.current_allocation);}
    ...
    a.native_site=0x007fdceb;calls.call_0058b520(counters,root(counters));reset_head(counters);
    ...
    header=at(profile,0x94);a.native_site=0x007fdd56;calls.call_007fa880(header,root(header));reset_head(header);
    word(profile,0xe0,1);word(profile,0xe4,1);
    a.native_site=0x007fdd89;calls.call_0058b520(counters,root(counters));reset_head(counters);
    ...
    a.native_site=0x007fde14;calls.call_004d05e0(at(profile,8));
    ...
    a.native_site=0x007fdec2;calls.call_004d05e0(at(profile,0xcc));
