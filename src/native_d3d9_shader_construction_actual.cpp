...
struct ConstructionExecution {
    ...
    void support() {
        if (actual) {
            NativeResourceSupportRawContext support_context{
                actual->strings.actual_manager_publication_01090aa0,
                actual->actual_support_0108fedc};
            (void)resource_support_singleton_00b3e730(support_context);
