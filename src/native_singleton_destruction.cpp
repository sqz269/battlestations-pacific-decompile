    ...
    case 0x00ce3a44:
        if (bindings.native_profile_hints != nullptr) {
            delete_native_profile_hints_owner_00426320(owner, flags,
                *bindings.native_profile_hints);
            return;
        }
        break;
    case 0x00ce6c68:
        if (bindings.game_classes != nullptr) {
            delete_native_game_class_registered_owner(owner, flags, *bindings.game_classes);
            return;
        }
        break;
    case 0x00d5e480:
        if (bindings.render_resources != nullptr) {
            delete_native_render_resources_00b151c0(owner,flags,*bindings.render_resources);
            return;
        }
        break;
    case 0x00d5e5f4:
        if (bindings.render_queue != nullptr) {
            delete_native_render_queue_00b1f6b0(
                *static_cast<NativeRenderCommandQueueStorage*>(owner), flags,
                *bindings.render_queue);
            return;
        }
        break;
    case 0x00d68cbc:
    ...
    case 0x00d5e60c:
        if (bindings.renderer_record_guard != nullptr) {
            delete_native_renderer_record_guard_00b26130(
                owner, flags, *bindings.renderer_record_guard);
            return;
        }
        break;
    case 0x00ce752c:
