...
void torpedo_goaway_enter_tail_009d0e3a(const TorpedoGoAwayEnterTailInputs& in,
    ...
    // second is the squadron's shared cruising altitude (squadron+394h), reported as
    ...
    } else if (in.has_squadron_cruising_alt_394) {
        state.climb_altitude_1c = in.squadron_cruising_alt_394;
        state.climb_altitude_known = true;
    } else {
