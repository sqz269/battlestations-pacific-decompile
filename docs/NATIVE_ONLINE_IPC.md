...
Root integration correction at `96a02cf2f412ea132715fd9ddda7d1c98454f9a4`: after verifying 608 saved/live/disk bytes, root recreated the stored A4BDE0 and A4C030 function bodies while preserving names and plate comments. Their omitted tails now belong to the correct functions; all 24 direct call rows pass. `reports/native_online_ipc_function_definitions.json` preserves the mutation record. The historical worker audit with three failures remains archived. The nine-case fixture and real worker abort check were rebuilt and passed against the integrated library; no live pipe exchange or gameplay was exercised.
