...
Combined code `231ba1f32c4441e4b778e869474ff09740e892f1` passes the strict Win32 build, both existing CTests and the paired original/source fixture against its exact libraries. A manifest seals all2661 tracked source/build inputs. The separately reviewed gunnery command-target bridge is included; this does not newly certify native command queues, concrete parser bootstrap or gameplay.
