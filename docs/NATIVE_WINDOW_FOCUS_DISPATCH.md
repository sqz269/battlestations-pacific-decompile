...
Recovered from historical commit `9f62a71ac` for CC10. The validation below is
the original packet record; current verification and application-binding limits
are in `docs/PLATFORM_ACTIVATION_CC10.md` and its report. Historical fixtures
were not rerun during this recovery.
