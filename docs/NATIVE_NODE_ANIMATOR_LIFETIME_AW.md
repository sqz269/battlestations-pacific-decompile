...
Source commit `d3bb4d4fd6e465f951220a71726b322563df5ef8` contains the verified source. The build ran with the same owned source changes on `5de02dec4cd0b7e54d788c91ac5ad782dd253707`. The immutable local manifest retains 295 inputs and 96 artifacts, including all nineteen production objects linked by the probe, compiler/library/header inputs, original references, comparison images and Ghidra receipts. This establishes the stated source and fixture boundaries, not graph admission or gameplay. B780D0 stored-body attribution remains incomplete; initializers remain object-write fragments.
