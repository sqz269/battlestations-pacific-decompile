...
Commit `48fa1324d4f6bb13cc6d01221023cd754d0d8495` passes the Win32 build and both existing CTests. All 26 paired original-body cases pass against that exact library with repeat-stable normalized images. The 120-frame USN01 compatibility run passes finite-trajectory, stationary Airfield2, avoidance, generic-tick, participant, world-list and observer/pending-owner checks. The preserved executable SHA-256 is `37b5c4787d5f3edd868086a38935ea0838a789eeb4b855879e023f5423d5b0f7`. An immutable manifest retains reference bytes, raw images, compiled objects, compiler/header/library inputs, Ghidra receipts and mission artifacts. Actual spatial-index admission and gameplay parity remain unproved.

After merging separately published work, combined commit `4e5d1ac782b2048946a1f923239c78afa4af32f2` passes the build, both CTests and the same 120-frame compatibility checks. Its executable SHA-256 is `dd392394985a79960689d057b2062d4e887da870c1b5a21579e0626d72069d0e`. All 65 production objects linked into the spatial lifecycle fixture remain byte-identical to the sealed proof. The additional integration manifest is retained separately.
