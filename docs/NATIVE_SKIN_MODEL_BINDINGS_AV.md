...
Source commit `ed9831e6dd8bdc0d1c22463391c0ad3612200af7` contains the verified source. The build ran with the same owned source changes on `9467196ab2e673a9ee4a9d33c85342d7e453eeff`. The immutable local manifest retains 251 inputs and 77 artifacts, including all four production objects linked by the probe, compiler/library/header inputs, original references, comparison images and Ghidra receipts. This establishes the stated source and fixture boundaries, not graph admission or gameplay.
