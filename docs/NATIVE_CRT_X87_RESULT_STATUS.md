...
Primary registered all 1 complete source entries and passed the strict Win32 build, both existing CTests and eight fresh seeds. All three packets use the same frozen main library `b1fa83e3959f4db6a0cdeb207054a57057bea9749cd48f8b5d3037b7f09e14c5`. All163 bytes/57 instructions, six current literal reads and two provider calls proved; completeCFG visits allthree packedCW POP/RET exits. Complete83-byte errorcore/unary5-byte JMP+17h and concrete C27489 wholecompiled section/EBX save-restore checked. Three actual archive members/91 wholeCOFF sections. Persistent actual LegacyCrtMathRuntime/E16BD0/owningerrno and established FPIEEE,precision01,FP/status,Win32 exception and volatile-register limits remain. No runtime/linked-address/nativeSEH/originalcallerABI, fullpow/SSE2/gamma or game claim. Reviewed names and evidence are saved with prior comments retained; all affected exports were forcibly refreshed. Immutable primary evidence: `local/x87_result_status_primary/`.
