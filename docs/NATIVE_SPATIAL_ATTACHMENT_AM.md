...
After merging separately published work, combined commit `895dfaa8e76f28766013da2c7e9a498cb48ffc86` passes the build, both CTests and the same 120-frame compatibility checks. Its executable SHA-256 is `c3ca90eed94d298414288de73f216ecbafc46418583cab484b015481cc2a95a7`. All 73 production objects linked into the spatial attachment fixture remain byte-identical to the sealed proof. The additional integration manifest is retained separately.
