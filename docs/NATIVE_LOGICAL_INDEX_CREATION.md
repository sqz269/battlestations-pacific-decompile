...
## Integration analysis corrections

The primary integrator repaired the two returning-free call overrides at B22DBC and B4B131 with the official locked tool, saved Ghidra, and refreshed both exports. Neither routine retains a returning-call gap. B4B197..B4B19F remains unreachable alignment. Record: `reports/orch5_index_creation_flow_repair.json`. The consumed B1FE50 leaf is already defined as `BSP_Renderer_GetSecondaryStreamRegistrationByte`, body B1FE50..B1FE56. B4B380 is an allocation forwarder; its previous static-destructor-stub classification was incorrect. Reviewed names remain hypotheses.
