...
Commit `d41e3a0aa0443c7ca12e5eec5435dacf2769da91` passes the strict Win32 build and both existing CTests. The six paired original-body caller comparisons, 32 numerical variants and four source failures pass against that library; both x87 helpers match their original bytes exactly. The 120-frame USN01 compatibility run passes trajectory, avoidance, generic-tick, participant, world-list and observer/pending-owner checks. The executable SHA-256 is `8b8072a6ce1ea8f3c9814211d7a93260e477af857c72dec2b8c1dae81b1aa4a0`. An immutable local manifest retains 787 inputs, 129 artifacts and 60 linked production objects, including compiler/header/library inputs, the loaded D3DX DLL, original reference bytes, saved Ghidra receipts and mission artifacts. This records the compiled worktree; shared-main integration and publication are separate closeout steps. The compatibility run does not establish execution of the new bone caller. Full graph construction and the other postprocessor, complete factories and external item behavior, class+50 admission, physical mapping, native exception ABI and gameplay remain open.
