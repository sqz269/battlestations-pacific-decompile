...
Commit `7491f94a3686fb770aa483a3422c012f1e3b9f77` passes the strict Win32 build and both existing CTests. All six paired original-body cases and the source nested-unwind case pass against that library with repeat-stable normalized images. The 120-frame USN01 compatibility run passes finite-trajectory, stationary Airfield2, avoidance, generic-tick, participant, world-list and observer/pending-owner checks. The preserved executable SHA-256 is `195dfab56c6dadaf1e5d9a5677a8f38091b4c1db4a573f4362f706aeb84ce26b`. An immutable manifest retains 835 inputs, 92 artifacts and 81 linked production objects, including compiler/header/library inputs, original bytes, exception maps, Ghidra receipts, the disabled script response and mission artifacts. This does not establish populated raw part admission, native FH3 or gameplay parity.
