...
The integrated source at `33ac99a202f5630d2fe4e706609cb84fc7ffb7f9` passed the strict MSVC Win32 build and both CTests. Byte-identical linked52byte poll and four original/source raw-owner synthetic-COM cases; no actual GPU test.
