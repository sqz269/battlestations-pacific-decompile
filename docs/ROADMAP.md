...
Ghidra has 62 useful names with evidence comments; its incorrect CRT free noreturn flag is corrected.
...
and native reset dependencies are traced in `D3D9_RESOURCES.md`. Next, recover registry/base teardown
