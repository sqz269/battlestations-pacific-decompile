...
// actual parameter, EDX current bindings, stack time, RET4/ST0. Integer-only
// binding entries preserve caller-owned x87 values and the existing EAX/EDX
// behavior; there is no float-return wrapper spill.
