...
// The reached B24BF0 path requires an initialized real device at +1A10 and
// default color surface at +197C. Both device and factory must remain callable
// across the native unconditional Release and later AddRef/Release pairs.
// A constructor-only owner does not satisfy this destruction input domain.
