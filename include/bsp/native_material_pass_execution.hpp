...
// Each invocation needs a fresh pass frame and its own constant-builder frame.
// Completed or failed frames cannot be replayed; their diagnostics remain live.
