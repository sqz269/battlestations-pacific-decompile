...
// Full B5BE10 growth/shrink schedule; native signed comparisons and DWORD
// address arithmetic. Placement cleanup on growth failure is a no-op.
void resize_native_system_constants_00b5be10(NativeCompiledShaderConstants&,
    std::int32_t request, NativeStringRawPoolContext&);
// Full B5BF50: resize0 then free CURRENT data; pointer/capacity remain stale.
