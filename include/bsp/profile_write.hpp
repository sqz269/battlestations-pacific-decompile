...
// and word+4=0, then replace its vtable with00ce3784 before running the next
...
// other states write settings and run007fa220, retaining the callback slot.
...
// run007f9500. The writer is retired before driving the next operation.
...
// Host dispatch for the four recovered continuation addresses. The storage driver
// may invoke a continuation synchronously or retain it across a prompt.
