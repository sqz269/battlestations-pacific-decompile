...
// intrusive/provider-manager lifetime. Exact flags2/0x32 select the same
// inspected native read route; other open modes are excluded.
...
//00be7ab0 native ECX store, name/flags stack RET8. Projects flags2/0x32.
