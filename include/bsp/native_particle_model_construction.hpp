...
// arrays remain provisional; concrete cookie-array constructors are recovered.
...
struct NativeParticleModelConstructionAccess {
    ...
    const NativeParticlePreparationDispatch& preparation;
};
...
// Complete AFD2E0..AFD365 through concrete cookie-array/element dependencies.
...
NativeParticleModelArraysStorage* construct_native_particle_model_arrays_00afd2e0(
    void*, NativeNodeStorage&, std::int32_t count, const volatile std::uint32_t& one_00d7a24c);
